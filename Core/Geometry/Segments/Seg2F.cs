...
namespace Helion.Geometry.Segments
{
    public struct Seg2F
    {
        ...
        public Seg2F(Vec2F start, Vector2F end)
        {
            Start = start;
            End = end.Struct;
        }
        public Seg2F(Vector2F start, Vec2F end)
        {
            Start = start.Struct;
            End = end;
        }
        public Seg2F(Vector2F start, Vector2F end)
        {
            Start = start.Struct;
            End = end.Struct;
        }

        public static implicit operator Seg2F(ValueTuple<Vec2F, Vec2F> tuple)
        {
        ...
        public static Seg2F operator +(Seg2F self, Vec2F other) => new(self.Start + other, self.End + other);
        public static Seg2F operator +(Seg2F self, Vector2F other) => new(self.Start + other, self.End + other);
        public static Seg2F operator -(Seg2F self, Vec2F other) => new(self.Start - other, self.End - other);
        public static Seg2F operator -(Seg2F self, Vector2F other) => new(self.Start - other, self.End - other);
        public static bool operator ==(Seg2F self, Seg2F other) => self.Start == other.Start && self.End == other.End;
        public static bool operator !=(Seg2F self, Seg2F other) => !(self == other);
        ...
        public bool OnRight<T>(Segment2F<T> seg) where T : Vector2F => OnRight(seg.Start) && OnRight(seg.End);
        ...
        public override bool Equals(object? obj) => obj is Seg2F seg && Start == seg.Start && End == seg.End;
