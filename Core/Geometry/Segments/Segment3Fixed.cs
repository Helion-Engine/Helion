...
namespace Helion.Geometry.Segments
{
    public class Segment3Fixed
    {
        ...
        public Segment3Fixed(Vec3Fixed start, Vec3Fixed end)
        {
            Start = start;
            End = end;
        }

        public static implicit operator Segment3Fixed(ValueTuple<Vec3Fixed, Vec3Fixed> tuple)
        {
        ...
        public static Seg3Fixed operator +(Segment3Fixed self, Vec3Fixed other) => new(self.Start + other, self.End + other);
        public static Seg3Fixed operator +(Segment3Fixed self, Vector3Fixed other) => new(self.Start + other, self.End + other);
        public static Seg3Fixed operator -(Segment3Fixed self, Vec3Fixed other) => new(self.Start - other, self.End - other);
        public static Seg3Fixed operator -(Segment3Fixed self, Vector3Fixed other) => new(self.Start - other, self.End - other);
        public static bool operator ==(Segment3Fixed self, Segment3Fixed other) => self.Start == other.Start && self.End == other.End;
        public static bool operator !=(Segment3Fixed self, Segment3Fixed other) => !(self == other);
