...
namespace Helion.Geometry.Vectors
{
    public struct Vec4Fixed
    {
        ...
        public Vec4Fixed(Fixed x, Fixed y, Fixed z, Fixed w)
        {
            X = x;
            Y = y;
            Z = z;
        ...
        public static implicit operator Vec4Fixed(ValueTuple<Fixed, Fixed, Fixed, Fixed> tuple)
        {
        ...
        public static Vec4Fixed operator -(Vec4Fixed self) => new(-self.X, -self.Y, -self.Z, -self.W);
        public static Vec4Fixed operator +(Vec4Fixed self, Vec4Fixed other) => new(self.X + other.X, self.Y + other.Y, self.Z + other.Z, self.W + other.W);
        public static Vec4Fixed operator +(Vec4Fixed self, Vector4Fixed other) => new(self.X + other.X, self.Y + other.Y, self.Z + other.Z, self.W + other.W);
        public static Vec4Fixed operator -(Vec4Fixed self, Vec4Fixed other) => new(self.X - other.X, self.Y - other.Y, self.Z - other.Z, self.W - other.W);
        public static Vec4Fixed operator -(Vec4Fixed self, Vector4Fixed other) => new(self.X - other.X, self.Y - other.Y, self.Z - other.Z, self.W - other.W);
        public static Vec4Fixed operator *(Vec4Fixed self, Vec4Fixed other) => new(self.X * other.X, self.Y * other.Y, self.Z * other.Z, self.W * other.W);
        public static Vec4Fixed operator *(Vec4Fixed self, Vector4Fixed other) => new(self.X * other.X, self.Y * other.Y, self.Z * other.Z, self.W * other.W);
        public static Vec4Fixed operator *(Vec4Fixed self, Fixed value) => new(self.X * value, self.Y * value, self.Z * value, self.W * value);
        public static Vec4Fixed operator *(Fixed value, Vec4Fixed self) => new(self.X * value, self.Y * value, self.Z * value, self.W * value);
        public static Vec4Fixed operator /(Vec4Fixed self, Vec4Fixed other) => new(self.X / other.X, self.Y / other.Y, self.Z / other.Z, self.W / other.W);
        public static Vec4Fixed operator /(Vec4Fixed self, Vector4Fixed other) => new(self.X / other.X, self.Y / other.Y, self.Z / other.Z, self.W / other.W);
        public static Vec4Fixed operator /(Vec4Fixed self, Fixed value) => new(self.X / value, self.Y / value, self.Z / value, self.W / value);
        public static bool operator ==(Vec4Fixed self, Vec4Fixed other) => self.X == other.X && self.Y == other.Y && self.Z == other.Z && self.W == other.W;
        public static bool operator ==(Vec4Fixed self, Vector4Fixed other) => self.X == other.X && self.Y == other.Y && self.Z == other.Z && self.W == other.W;
        public static bool operator !=(Vec4Fixed self, Vec4Fixed other) => !(self == other);
        public static bool operator !=(Vec4Fixed self, Vector4Fixed other) => !(self == other);
