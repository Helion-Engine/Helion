...
namespace Helion.Geometry.Vectors
{
    public class Vector3D
    {
        ...
        public static readonly Vector3D One = (1, 1, 1);
        ...
        public static implicit operator Vector3D(ValueTuple<double, double, double> tuple)
        {
        ...
        public static Vec3D operator /(Vector3D self, Vector3D other) => new(self.X / other.X, self.Y / other.Y, self.Z / other.Z);
        public static Vec3D operator /(Vector3D self, double value) => new(self.X / value, self.Y / value, self.Z / value);
        public static bool operator ==(Vector3D self, Vec3D other) => self.X == other.X && self.Y == other.Y && self.Z == other.Z;
        public static bool operator ==(Vector3D self, Vector3D other) => self.X == other.X && self.Y == other.Y && self.Z == other.Z;
        public static bool operator !=(Vector3D self, Vec3D other) => !(self == other);
