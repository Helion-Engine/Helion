...
namespace Helion.Geometry.Vectors
{
    ...
    {
        public static readonly Vector4D Zero = (0, 0, 0, 0);
        public static readonly Vector4D One = (1, 1, 1, 1);
        ...
        public Vec4D Struct => new(X, Y, Z, W);
        ...
        public static implicit operator Vector4D(ValueTuple<double, double, double, double> tuple)
        {
        ...
        public static Vec4D operator -(Vector4D self) => new(-self.X, -self.Y, -self.Z, -self.W);
        public static Vec4D operator +(Vector4D self, Vec4D other) => new(self.X + other.X, self.Y + other.Y, self.Z + other.Z, self.W + other.W);
        public static Vec4D operator +(Vector4D self, Vector4D other) => new(self.X + other.X, self.Y + other.Y, self.Z + other.Z, self.W + other.W);
        public static Vec4D operator -(Vector4D self, Vec4D other) => new(self.X - other.X, self.Y - other.Y, self.Z - other.Z, self.W - other.W);
        public static Vec4D operator -(Vector4D self, Vector4D other) => new(self.X - other.X, self.Y - other.Y, self.Z - other.Z, self.W - other.W);
        public static Vec4D operator *(Vector4D self, Vec4D other) => new(self.X * other.X, self.Y * other.Y, self.Z * other.Z, self.W * other.W);
        public static Vec4D operator *(Vector4D self, Vector4D other) => new(self.X * other.X, self.Y * other.Y, self.Z * other.Z, self.W * other.W);
        public static Vec4D operator *(Vector4D self, double value) => new(self.X * value, self.Y * value, self.Z * value, self.W * value);
        public static Vec4D operator *(double value, Vector4D self) => new(self.X * value, self.Y * value, self.Z * value, self.W * value);
        public static Vec4D operator /(Vector4D self, Vec4D other) => new(self.X / other.X, self.Y / other.Y, self.Z / other.Z, self.W / other.W);
        public static Vec4D operator /(Vector4D self, Vector4D other) => new(self.X / other.X, self.Y / other.Y, self.Z / other.Z, self.W / other.W);
        public static Vec4D operator /(Vector4D self, double value) => new(self.X / value, self.Y / value, self.Z / value, self.W / value);
        public static bool operator ==(Vector4D self, Vec4D other) => self.X == other.X && self.Y == other.Y && self.Z == other.Z && self.W == other.W;
        public static bool operator ==(Vector4D self, Vector4D other) => self.X == other.X && self.Y == other.Y && self.Z == other.Z && self.W == other.W;
        public static bool operator !=(Vector4D self, Vec4D other) => !(self == other);
        public static bool operator !=(Vector4D self, Vector4D other) => !(self == other);
        ...
        public override bool Equals(object? obj) => obj is Vector4D v && X == v.X && Y == v.Y && Z == v.Z && W == v.W;
