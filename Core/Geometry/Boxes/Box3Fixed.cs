...
public readonly struct Box3Fixed
{
    ...
    public static Box3Fixed operator *(Box3Fixed self, Fixed scale) => new(self.Min * scale, self.Max * scale);
    public static Box3Fixed operator /(Box3Fixed self, Fixed divisor) => new(self.Min / divisor, self.Max / divisor);
