...
public readonly struct Box2I
{
    ...
    public static Box2I operator *(Box2I self, int scale) => new(self.Min * scale, self.Max * scale);
    public static Box2I operator /(Box2I self, int divisor) => new(self.Min / divisor, self.Max / divisor);
