...
public class BoundingBox3F
{
    ...
    public static Box3F operator *(BoundingBox3F self, float scale) => new(self.Min * scale, self.Max * scale);
    public static Box3F operator /(BoundingBox3F self, float divisor) => new(self.Min / divisor, self.Max / divisor);
