...
public readonly struct PlayerPosition(Vec3D position, Vec3D viewDirection, double angleRadians, double pitchRadians, int id, bool markLines)
{
    ...
    public readonly bool MarkLines = markLines;
}
