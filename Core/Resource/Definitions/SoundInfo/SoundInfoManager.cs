...
namespace Helion.Resource.Definitions.SoundInfo
{
    public class SoundInfoManager
    {
        private readonly Dictionary<string, SoundInfo> m_lookup = new();
        private readonly Dictionary<string, List<string>> m_randomLookup = new();

        private readonly List<string> m_tokens = new();
        ...
        public void Parse(Entry entry)
        {
            ...
            foreach (string line in lines)
            {
                ...
                m_tokens.AddRange(parseLine.Split(new char[] { '\t', ' ' }, StringSplitOptions.RemoveEmptyEntries));
            }
