    ...
    private void SetTopLevelFlag(string flagName, bool flagValue)
    {
        switch (flagName.ToUpper())
        {
            ...
            case "E1M8BOSS":
                ...
                break;
            case "E2M8BOSS":
                m_currentDefinition.Flags.E2M8Boss = flagValue;
                break;
            case "E3M8BOSS":
                m_currentDefinition.Flags.E3M8Boss = flagValue;
                break;
            case "E4M6BOSS":
                m_currentDefinition.Flags.E4M6Boss = flagValue;
                break;
            case "E4M8BOSS":
                m_currentDefinition.Flags.E4M8Boss = flagValue;
                break;
            case "FULLVOLSEE":
