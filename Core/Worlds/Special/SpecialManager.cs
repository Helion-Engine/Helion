...
namespace Helion.Worlds.Special
{
    public class SpecialManager : ITickable
    {
        ...
        public ISpecial CreateFloorRaiseSpecial(Sector sector, double amount, double speed, IWorldTexture? floorChangeTexture = null)
        {
            SectorMoveData moveData = new(SectorPlaneType.Floor, MoveDirection.Up, MoveRepetition.None, speed, 0, null, floorChangeTexture);
            return new SectorMoveSpecial(m_world, sector, sector.Floor.Z, sector.Floor.Z + amount, moveData, GetDefaultSectorSound());
        }
        ...
        private bool HandleDefault(EntityActivateSpecialEventArgs args, LineSpecial special, World world)
        {
        ...
        {
            double destZ = sector.Floor.Z + sector.GetShortestLower();
            SectorMoveData moveData = new(SectorPlaneType.Floor, MoveDirection.Up, MoveRepetition.None, speed, 0);
        ...
        private void HandleFloorDonut(Line line, Sector sector)
        {
            ...
            AddSpecial(CreateFloorRaiseSpecial(raiseSector, destSector.Floor.Z - raiseSector.Floor.Z, line.Args.Arg2 * SpeedFactor, destSector.Floor.Texture));
        }
