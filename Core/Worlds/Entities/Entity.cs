...
using Helion.Worlds.Entities.Definition.Flags;
using Helion.Worlds.Entities.Definition.Properties;
...
namespace Helion.Worlds.Entities
{
    ...
    public partial class Entity : IDisposable, ITickable
    {
        ...
        public List<Sector> IntersectSectors = new();
        ...
        public Entity(int id, int thingId, EntityDefinition definition, in Vec3D position, double angleRadians,
            Sector sector, EntityManager entityManager, SoundManager soundManager, World world)
        {
