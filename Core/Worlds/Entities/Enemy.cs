...
namespace Helion.Worlds.Entities
{
    ...
    public partial class Entity
    {
        ...
        private static readonly double[] MoveAngles =
        {
            0.0,
        ...
        private static readonly MoveDir[] OppositeDirections = {
        ...
        private static readonly MoveDir[] Diagnals = { MoveDir.NorthWest, MoveDir.NorthEast, MoveDir.SoutWest, MoveDir.SouthEast };

        private static readonly double[] SpeedX = { 1.0, Speed, 0, -Speed, -1.0, -Speed, 0, Speed };
        private static readonly double[] SpeedY = { 0, Speed, 1.0, Speed, 0, -Speed, -1.0, -Speed };
