...
public enum VanillaLineSpecialType
{
    ...
    OffsetFloorByLineDirection = 2048,
    OffsetCeilingByLineDirection,
    OffsetFloorAndCeilingByLineDirection,
    RotateFloorByLineDirection,
    RotateCeilingByLineDirection,
    RotateFloorAndCeilingByLineDirection,
    OffsetThenRotateFloorByLineDirection,
    OffsetThenRotateCeilingByLineDirection,
    OffsetThenRotateFloorAndCeilingByLineDirection,
    W1_ChangeMusicAndLoop,
    WR_ChangeMusicAndLoop,
    S1_ChangeMusicAndLoop,
    SR_ChangeMusicAndLoop,
    G1_ChangeMusicAndLoop,
    GR_ChangeMusicAndLoop,
    W1_ChangeMusicPlayOnce,
    WR_ChangeMusicPlayOnce,
    S1_ChangeMusicPlayOnce,
    SR_ChangeMusicPlayOnce,
    G1_ChangeMusicPlayOnce,
    GR_ChangeMusicPlayOnce,
    W1_ExitResetInventory,
    S1_ExitResetInventory,
    G1_ExitResetInventory,
    W1_ExitSecretResetInventory,
    S1_ExitSecretResetInventory,
    G1_ExitSecretResetInventory,
    SetSectorColorMap,
    W1_SetSectorColorMap,
    WR_SetSectorColorMap,
    S1_SetSectorColorMap,
    SR_SetSectorColorMap,
    G1_SetSectorColorMap,
    GR_SetSectorColorMap,
    ScrollSidesToLinesLeftDirection,
    ScrollSidesToLinesRightDirection,
    ScrollSidesToSectorScrollValues,
    ScrollSidesToSectorMovement,
    ScrollSidesAccelerateToSectorMovement,
    W1_ChangeMusicAndLoopDefault,
    WR_ChangeMusicAndLoopDefault,
    S1_ChangeMusicAndLoopDefault,
    SR_ChangeMusicAndLoopDefault,
    G1_ChangeMusicAndLoopDefault,
    GR_ChangeMusicAndLoopDefault,
    W1_ChangeMusicPlayOnceDefault,
    WR_ChangeMusicPlayOnceDefault,
    S1_ChangeMusicPlayOnceDefault,
    SR_ChangeMusicPlayOnceDefault,
    G1_ChangeMusicPlayOnceDefault,
    GR_ChangeMusicPlayOnceDefault,
    Max
}
