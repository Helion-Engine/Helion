namespace Helion.MapsNew.Doom.Components.Types
{
    public struct DoomLineFlags
    {
        ...
        public const ushort UpperUnpeggedMask = 0x0004;
        public const ushort LowerUnpeggedMask = 0x0008;
        public const ushort DrawAsOneSidedAutomapMask = 0x0010;
        public const ushort BlockSoundMask = 0x0020;
        public const ushort NoDrawAutomapMask = 0x0040;
        public const ushort AlwaysDrawAutomapMask = 0x0080;
