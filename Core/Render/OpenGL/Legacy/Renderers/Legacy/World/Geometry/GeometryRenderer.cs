...
using Helion.Render.OpenGL.Legacy.Renderers.Legacy.World.Sky;
using Helion.Render.OpenGL.Legacy.Renderers.Legacy.World.Sky.Sphere;
using Helion.Render.OpenGL.Legacy.Shared;
using Helion.Render.OpenGL.Legacy.Shared.World;
...
namespace Helion.Render.OpenGL.Legacy.Renderers.Legacy.World.Geometry
{
