...
public class GLTextureManager : IDisposable
{
    ...
    public readonly GLBufferTexture<float> TranslationTableBuffer = new("Translation table", new float[MaxSupportedTextures], SizedInternalFormat.R32f, false);
    public readonly GLBufferTexture<float> TextureHandleBuffer = new("Texture handle", new float[MaxSupportedTextures], SizedInternalFormat.R32f, false);
