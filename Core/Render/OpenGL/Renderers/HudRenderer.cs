...
public abstract class HudRenderer : IDisposable
{
    ...
    public abstract void DrawImage(string textureName, Vec2I topLeft, Color multiplyColor, float alpha, bool drawInvul, bool drawFuzz, bool drawColorMap, int colorMapIndex);
    public abstract void DrawImage(string textureName, ImageBox2I drawArea, Color multiplyColor, float alpha, bool drawInvul, bool drawFuzz, bool drawColorMap, int colorMapIndex);
