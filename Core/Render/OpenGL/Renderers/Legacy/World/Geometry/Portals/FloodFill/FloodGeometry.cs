...
public readonly struct FloodGeometry(int key, int textureHandle, int lightIndex, float colorMapAndLightLevel, int vboOffset, int vertices)
{
    public readonly int Key = key;
    public readonly int TextureHandle = textureHandle;
    public readonly int LightIndex = lightIndex;
    public readonly float ColorMapAndLightLevel = colorMapAndLightLevel;
