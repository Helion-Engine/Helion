...
namespace Helion.Render.OpenGL.Renderers.Legacy.Worlds.Entities
{
    public class EntityRenderer
    {
        ...
        {
            // TODO: Preload all the world textures if we want to.
        }

        public void Clear(World world, double tickFraction, Entity cameraEntity)
        {
            ...
            GLLegacyTexture texture, bool mirror)
        {
            ...
            entityCenterXY.X += rightNormal.X * texture.Texture.Image.Offset.X;
            entityCenterXY.Y += rightNormal.Y * texture.Texture.Image.Offset.X;
            ...
            float bottomZ = (float)entityCenterBottom.Z + texture.Texture.Image.Offset.Y;
        ...
        private void RenderEntity(Entity entity, in Vec2D position, in Vec2D viewDirection)
        {
            ...
            Sprite sprite = entity.Frame.Sprite;
            ...
            GLLegacyTexture texture = m_textureManager.GetTexture(spriteRotation.Texture);
