...
using Helion.Render.OpenGL.Renderers.Legacy.Worlds.Entities;
using Helion.Render.OpenGL.Renderers.Legacy.Worlds.Geometry;
...
namespace Helion.Render.OpenGL.Renderers.Legacy.Worlds
{
    public class LegacyWorldRenderer : WorldRenderer
    {
        ...
        public LegacyWorldRenderer(Config config, Resources resources, GLCapabilities capabilities,
            IGLFunctions functions, LegacyGLTextureManager textureManager)
        {
            ...
            m_geometryRenderer = new GeometryRenderer(config, resources, capabilities, functions,
        ...
        protected override void UpdateToNewWorld(World world)
        {
            m_geometryRenderer.UpdateTo(world);
            m_entityRenderer.UpdateTo(world);
        }

        protected override void PerformRender(World world, RenderInfo renderInfo)
        {
        ...
        private void Clear(World world, RenderInfo renderInfo)
        {
            m_viewClipper.Clear();
        ...
        private void TraverseBsp(World world, RenderInfo renderInfo)
        {
