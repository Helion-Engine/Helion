...
namespace Helion.Render.OpenGL.Renderers.Legacy.Worlds.Sky.Sphere
{
    public class SkySphereComponent : ISkyComponent
    {
        ...
        public SkySphereComponent(Config config, Resources resources, GLCapabilities capabilities,
            IGLFunctions functions, LegacyGLTextureManager textureManager)
        {
            m_config = config;
            gl = functions;
            m_skySphereRenderer = new SkySphereRenderer(resources, capabilities, functions, textureManager);
