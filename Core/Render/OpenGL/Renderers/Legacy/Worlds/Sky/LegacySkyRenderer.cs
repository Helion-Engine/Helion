...
namespace Helion.Render.OpenGL.Renderers.Legacy.Worlds.Sky
{
    public class LegacySkyRenderer : IDisposable
    {
        ...
        public LegacySkyRenderer(Config config, Resources resources, GLCapabilities capabilities,
            IGLFunctions functions, LegacyGLTextureManager textureManager)
        {
            gl = functions;
            DefaultSky = new SkySphereComponent(config, resources, capabilities, functions, textureManager);
