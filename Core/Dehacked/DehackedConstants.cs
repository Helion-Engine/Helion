...
public partial class DehackedDefinition
{
    ...
    public readonly IReadOnlyDictionary<ThingState, FrameStateLookup> FrameLookup = new Dictionary<ThingState, FrameStateLookup>()
    {
        ...
        { ThingState.BSPI_RUN1,     new("Arachnotron::see",             1) },
        { ThingState.BSPI_RUN2,     new("Arachnotron::see",             2) },
        { ThingState.BSPI_RUN3,     new("Arachnotron::see",             3) },
        { ThingState.BSPI_RUN4,     new("Arachnotron::see",             4) },
        { ThingState.BSPI_RUN5,     new("Arachnotron::see",             5) },
        { ThingState.BSPI_RUN6,     new("Arachnotron::see",             6) },
        { ThingState.BSPI_RUN7,     new("Arachnotron::see",             7) },
        { ThingState.BSPI_RUN8,     new("Arachnotron::see",             8) },
        { ThingState.BSPI_RUN9,     new("Arachnotron::see",             9) },
        { ThingState.BSPI_RUN10,    new("Arachnotron::see",             10) },
        { ThingState.BSPI_RUN11,    new("Arachnotron::see",             11) },
        { ThingState.BSPI_RUN12,    new("Arachnotron::see",             12) },
    ...
    public readonly IReadOnlyDictionary<ThingState, string> ActionFunctionLookup = new Dictionary<ThingState, string>()
    {
        ...
        { ThingState.BSPI_RUN7, "A_BabyMetal" },
        { ThingState.BSPI_RUN8, "A_Chase" },
