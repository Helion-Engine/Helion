...
namespace Helion.Dehacked
{
    public partial class DehackedDefinition
    {
        ...
        public readonly IReadOnlyDictionary<ThingState, FrameStateLookup> FrameLookup = new Dictionary<ThingState, FrameStateLookup>()
        {
            ...
            { ThingState.SPAWNFIRE1,    new("BossEye::spawn",               0) },
            { ThingState.SPAWNFIRE2,    new("BossEye::spawn",               1) },
            { ThingState.SPAWNFIRE3,    new("BossEye::spawn",               2) },
            { ThingState.SPAWNFIRE4,    new("BossEye::spawn",               3) },
            { ThingState.SPAWNFIRE5,    new("BossEye::spawn",               4) },
            { ThingState.SPAWNFIRE6,    new("BossEye::spawn",               5) },
            { ThingState.SPAWNFIRE7,    new("BossEye::spawn",               6) },
            { ThingState.SPAWNFIRE8,    new("BossEye::spawn",               7) },
