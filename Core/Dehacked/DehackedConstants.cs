...
namespace Helion.Dehacked
{
    public partial class DehackedDefinition
    {
        ...
        public readonly IReadOnlyDictionary<ThingState, string> ActionFunctionLookup = new Dictionary<ThingState, string>()
        {
            ...
            { ThingState.SPOS_ATK2, "A_SPosAttack" },
            ...
            { ThingState.SPID_ATK2, "A_SPosAttack" },
            { ThingState.SPID_ATK3, "A_SPosAttack" },
        ...
        public readonly ThingStateLookup[] ThingStateLookups = new[]
        {
            ...
            new ThingStateLookup("SSWV", 0),                 // SSWV_STND,
            new ThingStateLookup("SSWV", 1),                 // SSWV_STND2,
            new ThingStateLookup("SSWV", 2),                 // SSWV_RUN1,
            new ThingStateLookup("SSWV", 3),                 // SSWV_RUN2,
            new ThingStateLookup("SSWV", 4),                 // SSWV_RUN3,
            new ThingStateLookup("SSWV", 5),                 // SSWV_RUN4,
            new ThingStateLookup("SSWV", 6),                 // SSWV_RUN5,
            new ThingStateLookup("SSWV", 7),                 // SSWV_RUN6,
            new ThingStateLookup("SSWV", 8),                 // SSWV_RUN7,
            new ThingStateLookup("SSWV", 9),                 // SSWV_RUN8,
            new ThingStateLookup("SSWV", 10),                // SSWV_ATK1,
            new ThingStateLookup("SSWV", 11),                // SSWV_ATK2,
            new ThingStateLookup("SSWV", 12),                // SSWV_ATK3,
            new ThingStateLookup("SSWV", 13),                // SSWV_ATK4,
            new ThingStateLookup("SSWV", 14),                // SSWV_ATK5,
            new ThingStateLookup("SSWV", 15),                // SSWV_ATK6,
            new ThingStateLookup("SSWV", 16),                // SSWV_PAIN,
            new ThingStateLookup("SSWV", 17),                // SSWV_PAIN2,
            new ThingStateLookup("SSWV", 18),                // SSWV_DIE1,
            new ThingStateLookup("SSWV", 19),                // SSWV_DIE2,
            new ThingStateLookup("SSWV", 20),                // SSWV_DIE3,
            new ThingStateLookup("SSWV", 21),                // SSWV_DIE4,
            new ThingStateLookup("SSWV", 22),                // SSWV_DIE5,
            new ThingStateLookup("SSWV", 23),                // SSWV_XDIE1,
            new ThingStateLookup("SSWV", 24),                // SSWV_XDIE2,
            new ThingStateLookup("SSWV", 25),                // SSWV_XDIE3,
            new ThingStateLookup("SSWV", 26),                // SSWV_XDIE4,
            new ThingStateLookup("SSWV", 27),                // SSWV_XDIE5,
            new ThingStateLookup("SSWV", 28),                // SSWV_XDIE6,
            new ThingStateLookup("SSWV", 29),                // SSWV_XDIE7,
            new ThingStateLookup("SSWV", 30),                // SSWV_XDIE8,
            new ThingStateLookup("SSWV", 31),                // SSWV_XDIE9,
            new ThingStateLookup("SSWV", 32),                // SSWV_RAISE1,
            new ThingStateLookup("SSWV", 33),                // SSWV_RAISE2,
            new ThingStateLookup("SSWV", 34),                // SSWV_RAISE3,
            new ThingStateLookup("SSWV", 35),                // SSWV_RAISE4,
            new ThingStateLookup("SSWV", 36),                // SSWV_RAISE5,
            ...
            new ThingStateLookup("KEEN", 12),                // COMMKEEN11,
            new ThingStateLookup("KEEN", 13),                // COMMKEEN12,
            new ThingStateLookup("KEEN", 14),                // KEENPAIN,
            new ThingStateLookup("KEEN", 15),                // KEENPAIN2,
            ...
            new ThingStateLookup("SSWV", 0),                 // BRAINEYE,
            new ThingStateLookup("SSWV", 1),                 // BRAINEYESEE,
            new ThingStateLookup("SSWV", 2),                 // BRAINEYE1,
            ...
            new ThingStateLookup("BON2", 0),                 // BON2A,
            new ThingStateLookup("BON2", 1),                 // BON2B,
            new ThingStateLookup("BON2", 2),                 // BON2C,
            new ThingStateLookup("BON2", 3),                 // BON2D,
            new ThingStateLookup("BON2", 4),                 // BON2E,
            ...
            new ThingStateLookup("BSKULL", 0),               // BSKULL,
            new ThingStateLookup("BSKULL", 1),               // BSKULL2,
            new ThingStateLookup("RSKULL", 0),               // RSKULL,
            new ThingStateLookup("RSKULL", 1),               // RSKULL2,
            new ThingStateLookup("YSKULL", 0),               // YSKULL,
            new ThingStateLookup("YSKULL", 1),               // YSKULL2,
            ...
            new ThingStateLookup("PLAY", 0),                 // DEADTORSO,
            new ThingStateLookup("PLAY", 0),                 // DEADBOTTOM,
            ...
            new ThingStateLookup("CEYE", 0),                 // EVILEYE2,
            new ThingStateLookup("CEYE", 0),                 // EVILEYE3,
            new ThingStateLookup("CEYE", 0),                 // EVILEYE4,
            new ThingStateLookup("FSKU", 0),                 // FLOATSKULL,
            new ThingStateLookup("FSKU", 0),                 // FLOATSKULL2,
            new ThingStateLookup("FSKU", 0),                 // FLOATSKULL3,
            new ThingStateLookup("COL5", 0),                 // HEARTCOL,
            new ThingStateLookup("COL5", 0),                 // HEARTCOL2,
            new ThingStateLookup("TBLU", 0),                 // BLUETORCH,
            new ThingStateLookup("TBLU", 0),                 // BLUETORCH2,
            new ThingStateLookup("TBLU", 0),                 // BLUETORCH3,
            new ThingStateLookup("TBLU", 0),                 // BLUETORCH4,
            new ThingStateLookup("TGRN", 0),                 // GREENTORCH,
            new ThingStateLookup("TGRN", 0),                 // GREENTORCH2,
            new ThingStateLookup("TGRN", 0),                 // GREENTORCH3,
            new ThingStateLookup("TGRN", 0),                 // GREENTORCH4,
            new ThingStateLookup("TRED", 0),                 // REDTORCH,
            new ThingStateLookup("TRED", 0),                 // REDTORCH2,
            new ThingStateLookup("TRED", 0),                 // REDTORCH3,
            new ThingStateLookup("TRED", 0),                 // REDTORCH4,
            new ThingStateLookup("SMBT", 0),                 // BTORCHSHRT,
            new ThingStateLookup("SMBT", 0),                 // BTORCHSHRT2,
            new ThingStateLookup("SMBT", 0),                 // BTORCHSHRT3,
            new ThingStateLookup("SMBT", 0),                 // BTORCHSHRT4,
            new ThingStateLookup("SMGT", 0),                 // GTORCHSHRT,
            new ThingStateLookup("SMGT", 0),                 // GTORCHSHRT2,
            new ThingStateLookup("SMGT", 0),                 // GTORCHSHRT3,
            new ThingStateLookup("SMGT", 0),                 // GTORCHSHRT4,
            new ThingStateLookup("SMRT", 0),                 // RTORCHSHRT,
            new ThingStateLookup("SMRT", 0),                 // RTORCHSHRT2,
            new ThingStateLookup("SMRT", 0),                 // RTORCHSHRT3,
            new ThingStateLookup("SMRT", 0),                 // RTORCHSHRT4,
