...
namespace Helion.Dehacked
{
    public partial class DehackedDefinition
    {
        ...
        public readonly IReadOnlyDictionary<ThingState, FrameStateLookup> FrameLookup = new Dictionary<ThingState, FrameStateLookup>()
        {
            ...
            { ThingState.DOGS_ATK1,     new("MBFHelperDog::missile",        0) },
            { ThingState.DOGS_ATK2,     new("MBFHelperDog::missile",        1) },
            { ThingState.DOGS_ATK3,     new("MBFHelperDog::missile",        2) },
        ...
        public readonly ThingStateLookup[] ThingStateLookups = new[]
        {
            ...
            new ThingStateLookup("BFGG", 17),                // OLDBFG7,
            new ThingStateLookup("BFGG", 18),                // OLDBFG8,
            new ThingStateLookup("BFGG", 19),                // OLDBFG9,
            new ThingStateLookup("BFGG", 20),                // OLDBFG10,
            new ThingStateLookup("BFGG", 21),                // OLDBFG11,
            new ThingStateLookup("BFGG", 22),                // OLDBFG12,
            new ThingStateLookup("BFGG", 23),                // OLDBFG13,
            new ThingStateLookup("BFGG", 24),                // OLDBFG14,
            new ThingStateLookup("BFGG", 25),                // OLDBFG15,
            new ThingStateLookup("BFGG", 26),                // OLDBFG16,
            new ThingStateLookup("BFGG", 27),                // OLDBFG17,
            new ThingStateLookup("BFGG", 28),                // OLDBFG18,
            new ThingStateLookup("BFGG", 29),                // OLDBFG19,
            new ThingStateLookup("BFGG", 30),                // OLDBFG20,
            new ThingStateLookup("BFGG", 31),                // OLDBFG21,
            new ThingStateLookup("BFGG", 32),                // OLDBFG22,
            new ThingStateLookup("BFGG", 33),                // OLDBFG23,
            new ThingStateLookup("BFGG", 34),                // OLDBFG24,
            new ThingStateLookup("BFGG", 35),                // OLDBFG25,
            new ThingStateLookup("BFGG", 36),                // OLDBFG26,
            new ThingStateLookup("BFGG", 37),                // OLDBFG27,
            new ThingStateLookup("BFGG", 38),                // OLDBFG28,
            new ThingStateLookup("BFGG", 39),                // OLDBFG29,
            new ThingStateLookup("BFGG", 40),                // OLDBFG30,
            new ThingStateLookup("BFGG", 41),                // OLDBFG31,
            new ThingStateLookup("BFGG", 42),                // OLDBFG32,
            new ThingStateLookup("BFGG", 43),                // OLDBFG33,
            new ThingStateLookup("BFGG", 44),                // OLDBFG34,
            new ThingStateLookup("BFGG", 45),                // OLDBFG35,
            new ThingStateLookup("BFGG", 46),                // OLDBFG36,
            new ThingStateLookup("BFGG", 47),                // OLDBFG37,
            new ThingStateLookup("BFGG", 48),                // OLDBFG38,
            new ThingStateLookup("BFGG", 49),                // OLDBFG39,
            new ThingStateLookup("BFGG", 50),                // OLDBFG40,
            new ThingStateLookup("BFGG", 51),                // OLDBFG41,
            new ThingStateLookup("BFGG", 52),                // OLDBFG42,
            new ThingStateLookup("BFGG", 53),                // OLDBFG43,
            ...
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_RUN1,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_RUN2,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_RUN3,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_RUN4,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_ATK1,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_ATK2,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_ATK3,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_PAIN1,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_PAIN2,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_PAIN3,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE1,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE2,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE3,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE4,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE5,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE6,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE7,
            new ThingStateLookup("SKUL", 0, "BetaSkull"),    // BSKUL_DIE8,
