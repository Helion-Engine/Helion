...
public class HudRenderingContext : IDisposable
{
    ...
    public HudRenderingContext(IConfig config, GLAtlasTextureManager textureManager, HudRenderer hudRenderer)
    {
        m_config = config;
    ...
    public void FillRect(Box2I box, RgbColor color)
    {
        ...
        DrawImage(m_textureManager.WhiteHandle, box, blend: color);
    }
    ...
    private void DrawImage(TextureHandle handle, Box2I box, float scale = 1.0f, RgbColor? blend = null, float alpha = 1.0f)
    {
