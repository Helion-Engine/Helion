...
namespace Helion.Layer.Levels.Intermission;

public partial class IntermissionLayer : GameLayer
{
    ...
    public override double Priority => (double)LayerPriority.Intermission;
