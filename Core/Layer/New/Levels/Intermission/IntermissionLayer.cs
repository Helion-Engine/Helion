...
namespace Helion.Layer.New.Levels.Intermission;
...
public partial class IntermissionLayer : IGameLayer
{
    ...
    private readonly Layer.GameLayerManager m_gameLayerManager;
    ...
    public IntermissionLayer(Layer.GameLayerManager parent, IWorld world, SoundManager soundManager, IMusicPlayer musicPlayer,
        MapInfoDef currentMapInfo, MapInfoDef? nextMapInfo)
    {
        ...
        m_renderVirtualIntermissionAction = RenderVirtualIntermission;
