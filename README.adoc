...
The latest precompiled release for Windows and most Linux distros can be https://github.com/Helion-Engine/Helion/releases/latest[downloaded here].

See the bundled https://github.com/Helion-Engine/Helion/blob/dev/Assets/Documentation/README.md[game documentation] for information on setting up and playing.
