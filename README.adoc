...
The latest stable release for Windows and most Linux distros can be https://github.com/Helion-Engine/Helion/releases/latest[downloaded here]. Nightly experimental builds are also https://github.com/Helion-Engine/Helion/releases/tag/nightly[available here] for users who want to test the latest features.
...
If you want to build from source, see the https://github.com/Helion-Engine/Helion/blob/dev/INSTALL.adoc[build instructions].
