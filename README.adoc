...
|===
|[style="width:50%"]image:https://i.imgur.com/YBQJAc2.png[Doom E1M1 - True Color Mode]
Doom E1M1 - True Color Mode
|[style="width:50%"]image:https://i.imgur.com/WfNu68M.png[Doom E1M1 - Palette Color Mode]
Doom E1M1 - Palette Color Mode
|[style="width:50%"]image:https://i.imgur.com/lrksM1C.png[Eviternity MAP26 - Automap Overlay]
Eviternity MAP26 - Automap Overlay
|[style="width:50%"]image:https://i.imgur.com/iA4bVzs.png[Knee-Deep in Knee-Deep in ZDoom Z1M1]
Knee-Deep in Knee-Deep in ZDoom Z1M1
|[style="width:50%"]image:https://i.imgur.com/dVbYPg4.png[PUSSX Summer of Slaught MAP32]
PUSS X Summer of Slaughter MAP32
(SOS_BOOM.wad)
|[style="width:50%"]image:https://i.imgur.com/XyD6UA2.png[Sunlust MAP28]
Sunlust MAP28
|[style="width:50%"]image:https://i.imgur.com/1w9t5N1.png[Eviternity II MAP32]
Eviternity II MAP32
|
|===
