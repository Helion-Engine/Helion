...
The latest release can be https://github.com/helion/Helion/releases/latest[downloaded here].

See the https://github.com/helion/Helion/Assets/Documentation/README.md[game documentation] for information on setting up and playing.

If you want to build from source, see the https://github.com/helion/Helion/Assets/Documentation/README.md[Build Instructions].
