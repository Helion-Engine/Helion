...
Helion uses https://dotnet.microsoft.com/en-us/download/dotnet/9.0[.NET 9]. The self-contained Helion releases include it, otherwise you will need to install the Desktop Runtime. On Linux, you will also need to make sure OpenAL, libsndfile, and libmpg123 are installed.
