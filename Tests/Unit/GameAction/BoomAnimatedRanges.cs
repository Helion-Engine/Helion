...
public class BoomAnimatedRanges
{
    ...
    public void AnimatedRangeWithDuplicateTexture()
    {
        ...
        var animation = animations.First(x => x.AnimatedTexture.Name.Equals("KS_FLSG1", System.StringComparison.Ordinal)).AnimatedTexture;
        ...
        animation = animations.First(x => x.AnimatedTexture.Name.Equals("KS_FLSG6", System.StringComparison.Ordinal)).AnimatedTexture;
        animation.Components.Count.Should().Be(6);
