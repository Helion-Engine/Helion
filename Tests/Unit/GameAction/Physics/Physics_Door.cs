...
namespace Helion.Tests.Unit.GameAction
{
    public partial class Physics
    {
        ...
        public void DoorCeilingBelowFloor()
        {
            ...
            GameActions.ActivateLine(World, Player, 300, ActivationContext.UseLine).Should().BeTrue();
        ...
        public void DoorOpensDown()
        {
            ...
            GameActions.ActivateLine(World, Player, 306, ActivationContext.UseLine).Should().BeTrue();
        ...
        public void DoorOpenCloseDown()
        {
            ...
            sector.Ceiling.Z.Should().Be(0);
            GameActions.ActivateLine(World, Player, 318, ActivationContext.UseLine).Should().BeTrue();
            World.Tick();
