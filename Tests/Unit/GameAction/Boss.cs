...
public class Boss
{
    ...
    [Fact(DisplayName = "A_KeenDie")]
    public void A_KeenDie()
    {
        var world = WorldAllocator.LoadMap(Resource, File, "MAP08", GetType().Name, WorldInit, IWadType.Doom2);
        var keen1 = GameActions.GetEntity(world, 1);
        var keen2 = GameActions.GetEntity(world, 2);
