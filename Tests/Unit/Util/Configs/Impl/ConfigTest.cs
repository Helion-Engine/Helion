    ...
    public class ConfigTest
    {
        ...
        public void CanIterateOverAllElements()
        {
            ...
            Dictionary<string, IConfigValue> expected = new()
            {
                ...
                ["render.anisotropy.enable"] = m_config.Render.Anisotropy.Enable,
                ["render.anisotropy.usemaxsupported"] = m_config.Render.Anisotropy.UseMaxSupported,
                ["render.anisotropy.value"] = m_config.Render.Anisotropy.Value,
                ...
                ["render.multisample.enable"] = m_config.Render.Multisample.Enable,
                ["render.multisample.usemaxsupported"] = m_config.Render.Multisample.UseMaxSupported,
                ["render.multisample.value"] = m_config.Render.Multisample.Value,
