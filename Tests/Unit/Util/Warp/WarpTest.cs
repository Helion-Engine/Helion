...
namespace Helion.Tests.Unit.Util.Warp
{
    ...
    {
        private static readonly string[] EpisodeMaps = new string[] { "E1M1", "E1M2", "E2M1", "E2M8", "MAP01", "MAP10", "MAP16", "MAP21" };
        private static readonly string[] Maps = new string[] { "MAP01", "MAP10", "MAP16", "MAP21" };

        [Fact(DisplayName = "Episode Warp 11")]
        public void WarpE1M1()
        {
            MapInfoDef? mapInfoDef;
        ...
        public void Warp16()
        {
            MapInfoDef? mapInfoDef;
            MapInfo mapInfo = GetMapInfo();
            MapWarp.GetMap(16, mapInfo, out mapInfoDef).Should().BeTrue();
            mapInfoDef.Should().NotBeNull();
